...
function segmentShotPlan(segment, duration, performerCount = 1) {
  ...
  const plans = [
    { name: "locked-wide-to-locked-portrait", opening: "locked-off low wide 24 mm stage reveal", middle: "locked-off chest-up 50 mm frontal portrait", ending: "locked-off lateral medium-wide tableau" },
    { name: "locked-profile-to-locked-high-angle", opening: "locked-off side-profile 35 mm stage tableau", middle: "locked-off 85 mm three-quarter portrait with compressed background", ending: "locked-off high-angle stage geography tableau" },
    { name: "locked-audience-to-locked-low-angle", opening: "locked-off audience-side 28 mm point of view", middle: "locked-off low-angle 50 mm performer portrait", ending: "locked-off medium-wide tableau across the instrument line" },
    { name: "locked-rear-stage-to-locked-side", opening: "locked-off rear-stage 32 mm silhouette and depth composition", middle: "locked-off 70 mm side close-up with one restrained rack focus", ending: "locked-off wide full-band tableau that reverses the opening screen direction" },
    { name: "locked-high-angle-to-locked-detail", opening: "locked-off high-angle 24 mm formation map", middle: "locked-off tight 85 mm detail on face, hands, or microphone", ending: "locked-off diagonal full-band frame" },
    { name: "locked-telephoto-to-locked-frontal", opening: "locked-off long-lens 100 mm layered stage compression", middle: "locked-off 50 mm emotional close-up", ending: "locked-off frontal tableau after a hard axis change" },
  ];
